          ...
          <div className="">
            {datas.slice(2, 3).map(
              (
                ...
                <div
                  className=" flex justify-between  hover:bg-slate-200 w-[100%]  p-[10px] rounded-lg"
                  key={i}
                >
                  <div>
                    <img
                      ...
                      src={e.image}
                      alt="DandyChair"
                      className="h-[390px] w-[600px] sm:w-[550px] sm:h-[650px] md:h-[750px] md:w-[729px]"
                    />
                  </div>
